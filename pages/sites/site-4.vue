...
<template>
  <AFrameScene :load-systems="loadSystems">
    ...
    <a-gltf-model src=#wall1 position="1 1 1"></a-gltf-model>
    <a-gltf-model src=#wall2 position="6 6 6"></a-gltf-model>
    <a-gltf-model src=#rail1 position="3 3 3"></a-gltf-model>
    <a-gltf-model src=#rail2 position="4 4 4"></a-gltf-model>
    <a-gltf-model src=#post1 position="5 5 5"></a-gltf-model>
    <a-gltf-model src=#post2 position="7 7 7"></a-gltf-model>
    <a-audio-player
      src="#interview"
      position="0 1.6 -5"
      title="Interview"
